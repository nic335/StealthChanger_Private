...
| Lost Print Volume                                                                                      | Dock Repeatability                                                                                                                                                                                                                                                              | Crossbar Caviat                                                                                                                                                                                                                                           |
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| You will loose the Blue Square</br> +</br> total height of your longest tool.</br>Under the Dock<br /> | The sturdier the dock can be, the better it will be in term of realability.<br/>That said,</br>-the modular dock can be install hanging from the `top extrusion`,<br /><br />-Mounted on the `CrossBar`and`top extrusion`or even </br><br />-Mounted solely on to the`crossbar` | As you can see in the below example picture, Stock voron idlers will interfere with the`crossbar`<br /><br />There is 2 ways go from here.<br /><br />-MiniBFI<br />or <br />stack 2020 extrusion on top<br />or<br />`DoorBuffer`<br />See examples HERE |
| <img src="pictures/BuildLoss.png" alt="BuildLost" style="width: 500px"/>                               | <img src="./pictures/CrossBarExample.png" alt="CrossBar Example" style="width:500px;"/>                                                                                                                                                                                         | <img src="./pictures/CrossBarInterference.png" alt="crossbar interference with idlers" style="width:500px;">                                                                                                                                              |
